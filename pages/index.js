  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="grid lg:grid-cols-2 gap-8 items-center">
        <div>
          <motion.h1 initial={{opacity:0,y:6}} animate={{opacity:1,y:0}} className="text-3xl sm:text-5xl font-extrabold">
          ...
          <div className="mt-6 flex gap-3">
            <Link href="/upload"><a className="inline-flex items-center gap-2 btn-primary px-4 py-2 rounded-2xl shadow"> <Upload size={16}/> Upload</a></Link>
            <Link href="/community"><a className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl border border-white/10 hover:bg-white/5"> <Users size={16}/> Community</a></Link>
          </div>
        </div>
